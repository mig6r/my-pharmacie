 ...
 */
final class Version20190507093526 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE famille CHANGE admin_id admin_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE famille CHANGE admin_id admin_id INT DEFAULT NULL');
